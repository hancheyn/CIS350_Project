...
echo "</form></tr></table>  <div><form action=login.php  method='post'>
<div style='text-align:center; padding: 15px;'><form action=login.php  method='post'>
<input type= 'submit' name= 'change_back' style='text-align:center;' value='Login'></div></form></div>
</html>";
